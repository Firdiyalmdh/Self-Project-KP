<script>
    import { Input, Label, Button, Modal, Toast } from 'flowbite-svelte';
    ...
    <Modal bind:open={acceptModal} size="xs" autoclose={false} class="w-full">
      <form class="flex flex-col space-y-6" on:submit|preventDefault={acceptPermohonan}>
        <h3 class="mb-4 text-xl font-medium text-gray-900 dark:text-white">Masukkan Nomor Surat</h3>
        <Label class="space-y-2">
          <span>Nomor Surat</span>
          <Input type="text" placeholder="Contoh: 123/456/789" required />
        </Label>
    ...
    <Modal bind:open={rejectModal} size="xs" autoclose>
      <div class="text-center">
        ...
        <Button color="red" class="mr-2" on:click={rejectPermohonan}>Ya, tolak permohonan</Button>
