...
<div class="flex w-screen">
    <Sidebar class="min-w-[25%] bg-gradient-to-r from-purple-700 via-blue-00 to-purple-900 h-screen">
        ...
        <SidebarWrapper divClass="bg-transparent">
            <SidebarGroup>
            <SidebarItem label="Home" href={$url('/admin/home')} aClass="hover:bg-black/25 flex items-center p-2 text-base font-normal text-white rounded-lg">
            ...
            <SidebarItem label="Permohonan Nomor Surat" href={$url('/admin/nomor-surat')} aClass="hover:bg-black/25 flex items-center p-2 text-base font-normal text-white rounded-lg">
                <svelte:fragment slot="icon">
            ...
            <SidebarItem label="Permohonan Tanda Tangan"href={$url('/admin/ttd')} aClass="hover:bg-black/25 flex items-center p-2 text-base font-normal text-white rounded-lg">
                <svelte:fragment slot="icon">
                <svg class="w-6 h-6 text-white dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 20">
                    <path stroke="currentColor" stroke-linejoin="round" stroke-width="1" d="M6 1v4a1 1 0 0 1-1 1H1m14-4v16a.97.97 0 0 1-.933 1H1.933A.97.97 0 0 1 1 18V5.828a2 2 0 0 1 .586-1.414l2.828-2.828A2 2 0 0 1 5.828 1h8.239A.97.97 0 0 1 15 2Z"/>
                </svg>          </svelte:fragment>
            ...
            <SidebarDropdownWrapper label="Berkas Masuk" btnClass="flex items-center p-2 w-full text-base font-normal text-white rounded-lg transition duration-75 group hover:bg-black/25 dark:text-white dark:hover:bg-gray-700" spanClass="grow-0 mx-3">
                ...
                <SidebarDropdownItem label="Kerja Praktik" href={$url('/admin/kerja-praktik')} aClass="flex items-center p-2 pl-11 w-full text-base font-normal text-white rounded-lg transition duration-75 group hover:bg-black/25 dark:text-white dark:hover:bg-gray-700"/>
                <SidebarDropdownItem label="Proyek Akhir" href={$url('/admin/tugas-akhir')} aClass="flex items-center p-2 pl-11 w-full text-base font-normal text-white rounded-lg transition duration-75 group hover:bg-black/25 dark:text-white dark:hover:bg-gray-700"/>
                <SidebarDropdownItem label="PKM" href={$url('/admin/pkm')} aClass="flex items-center p-2 pl-11 w-full text-base font-normal text-white rounded-lg transition duration-75 group hover:bg-black/25 dark:text-white dark:hover:bg-gray-700"/>
