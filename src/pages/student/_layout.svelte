...
<div class="flex w-full">
    <Sidebar class="w-1/4 bg-gradient-to-r from-cyan-700 via-blue-00 to-blue-900 h-screen">
        ...
        <SidebarWrapper divClass="bg-transparent">
            <SidebarGroup>
            <SidebarItem label="Home" href={$url('/student/home')} aClass="hover:bg-black/25 flex items-center p-2 text-base font-normal text-white rounded-lg">
            ...
            <SidebarItem label="Permohonan Nomor Surat" href={$url('/student/nomor-surat')} aClass="hover:bg-black/25 flex items-center p-2 text-base font-normal text-white rounded-lg">
                <svelte:fragment slot="icon">
            ...
            <SidebarItem label="Permohonan Tanda Tangan"href={$url('/student/ttd')} aClass="hover:bg-black/25 flex items-center p-2 text-base font-normal text-white rounded-lg">
                <svelte:fragment slot="icon">
                <svg class="w-6 h-6 text-white dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 20">
                    <path stroke="currentColor" stroke-linejoin="round" stroke-width="1" d="M6 1v4a1 1 0 0 1-1 1H1m14-4v16a.97.97 0 0 1-.933 1H1.933A.97.97 0 0 1 1 18V5.828a2 2 0 0 1 .586-1.414l2.828-2.828A2 2 0 0 1 5.828 1h8.239A.97.97 0 0 1 15 2Z"/>
                </svg>          </svelte:fragment>
            </SidebarItem>
            <SidebarDropdownWrapper label="Pengumpulan Berkas" btnClass="flex items-center p-2 w-full text-base font-normal text-white rounded-lg transition duration-75 group hover:bg-black/25 dark:text-white dark:hover:bg-gray-700" spanClass="grow-0 mx-3">
                <svelte:fragment slot="icon">
                ...
                <SidebarDropdownItem label="Kerja Praktik" href={$url('/student/kerja-praktik')} aClass="flex items-center p-2 pl-11 w-full text-base font-normal text-white rounded-lg transition duration-75 group hover:bg-black/25 dark:text-white dark:hover:bg-gray-700"/>
                <SidebarDropdownItem label="Proyek Akhir" href={$url('/student/tugas-akhir')} aClass="flex items-center p-2 pl-11 w-full text-base font-normal text-white rounded-lg transition duration-75 group hover:bg-black/25 dark:text-white dark:hover:bg-gray-700"/>
                <SidebarDropdownItem label="PKM" href={$url('/student/pkm')} aClass="flex items-center p-2 pl-11 w-full text-base font-normal text-white rounded-lg transition duration-75 group hover:bg-black/25 dark:text-white dark:hover:bg-gray-700"/>
